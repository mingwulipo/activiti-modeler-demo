 ...
 */
@Data
public class UserTaskDto implements ChildElementDto {
    private String resourceId;
    private UserTaskPropertiesDto properties;
    private ProcessStencilDto stencil = new ProcessStencilDto("UserTask");
