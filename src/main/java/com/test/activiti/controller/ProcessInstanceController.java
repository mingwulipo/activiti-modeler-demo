...
public class ProcessInstanceController {
    ...
    public String goImage(String processInstanceId, Model model) {
        ...
        model.addAttribute("imgMain", "<img style='position: absolute;top: 0px;left: 0px;' "
                + "src='/processDefinitions/showPng?processDefinitionId=" + processInstance.getProcessDefinitionId() + "'>");

        ActivityVO activity = getActivity(processInstanceId);
        model.addAttribute("imgActivity", "<div style='position: absolute;border:1px solid red;top:"
